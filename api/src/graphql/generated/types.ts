...
> = ResolversObject<{
  ...
  >
  joinConversation?: Resolver<
    ResolversTypes['Conversation'],
    ParentType,
    ContextType,
    RequireFields<MutationJoinConversationArgs, 'id'>
  >
  updateConversation?: Resolver<
    ResolversTypes['Conversation'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateConversationArgs, 'id' | 'input'>
  >
}>
...
> = ResolversObject<{
  ...
  publicConversations?: Resolver<
    Array<ResolversTypes['Conversation']>,
    ParentType,
    ContextType,
    Partial<QueryPublicConversationsArgs>
  >
}>
